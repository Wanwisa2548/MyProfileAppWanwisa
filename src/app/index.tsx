...
const styles = StyleSheet.create({
  ...
  dashboardBtn: { backgroundColor: "#8b5cf6", paddingHorizontal: 10, paddingVertical: 5, borderRadius: 20 },
  manageBtn: { backgroundColor: "#0284c7", paddingHorizontal: 10, paddingVertical: 5, borderRadius: 20 },
  ...
  categoryChip: { paddingHorizontal: 18, paddingVertical: 8, borderRadius: 24, backgroundColor: "#fff", marginRight: 10, borderWidth: 1, borderColor: "#e2e8f0" },
  ...
  card: { width: "48%", backgroundColor: "#fff", borderRadius: 10, padding: 10, marginBottom: 10, borderWidth: 1, borderColor: "#f1f5f9" },
  ...
  lockedTitle: { fontSize: 20, fontWeight: "700", color: "#0f172a", marginTop: 16 },
  lockedSubtitle: { fontSize: 14, color: "#64748b", textAlign: "center", marginBottom: 32 },
